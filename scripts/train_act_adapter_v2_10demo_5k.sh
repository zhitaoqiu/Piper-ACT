#!/bin/bash
# ============================================================
# ACT Training — Adapter v2 10-Demo 5K-Step (comparison)
# ============================================================
# Dataset:
#   data/lerobot_dataset_piper_bottle_adapter_v2_10demo/
#
# Output:
#   outputs/train/act_adapter_v2_10demo_5k/
#
# This is a cheap comparison: same 10 demos, longer training.
# Only use if 25-demo training does not clearly improve success.
# ============================================================
set -euo pipefail
...
DATASET_REPO_ID="${DATASET_REPO_ID:-piper/adapter_v2_10demo_5k}"
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/outputs/train/act_adapter_v2_10demo_5k}"
STEPS="${STEPS:-5000}"
...
echo "================================================"
echo "  ACT Adapter v2 10-Demo 5K-Step (comparison)"
echo "================================================"
...
PYTHONPATH= "${PYTHON_BIN}" -m lerobot.scripts.lerobot_train \
    ...
    --job_name=act_adapter_v2_10demo_5k
